...
class Database:
        ...
        def data_updater():
                ...
                for country in countries_dictionary[0]:
                        ...
                        Database.cursor.execute("update covid_stat set Last_update_date = %s, Last_update_time = %s, Cases = %s, New_cases = %s, Active_cases = %s, Cases_per1M = %s, Recovered = %s, New_recovered = %s, Critical_cases = %s, Deaths = %s, New_deaths = %s, Deaths_per1M = %s, Tests = %s, Tests_per1M = %s where country = " + """'""" + country + """'""", 
                        (country_datestamp, country_timestamp, country_data_list[0], country_data_list[1], country_data_list[5], country_data_list[7], country_data_list[4], country_data_list[11], country_data_list[6], country_data_list[2], country_data_list[3], country_data_list[8], country_data_list[9], country_data_list[10],))
                        Database.connection_to_the_database.commit()
